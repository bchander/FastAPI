1. ImageArt webAPI is created using FastAPI in Python
2. The task is to allow user to upload an image to the api and an ML (KMeans clustering) does the image tranformation work
3. requirements file install the necessary libraries needed for this project
4. Main function is what executes the project
